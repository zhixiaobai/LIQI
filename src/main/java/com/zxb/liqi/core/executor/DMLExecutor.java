 ...
 * @Description
 */
public class DMLExecutor implements BaseExecutor {
    private final BaseHandler handler;
    private final Class<?> entityClass;
    private final PreparedStatement preparedStatement;
    private final Connection connection;

    public DMLExecutor(BaseHandler handler, Class<?> entityClass, Connection connection, PreparedStatement preparedStatement) {
